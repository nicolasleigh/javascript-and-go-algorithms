...
<div><div class="elfjS" data-track-load="description_content"><p>Alice 有 <code>n</code> 枚糖，其中第 <code>i</code> 枚糖的类型为 <code>candyType[i]</code> 。Alice 注意到她的体重正在增长，所以前去拜访了一位医生。</p>
...
<pre><strong>输入：</strong>candyType = [1,1,2,2,3,3]
<strong>输出：</strong>3
...
<pre><strong>输入：</strong>candyType = [1,1,2,3]
<strong>输出：</strong>2
...
<pre><strong>输入：</strong>candyType = [6,6,6,6]
<strong>输出：</strong>1
